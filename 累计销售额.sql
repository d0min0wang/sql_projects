...
FROM(
    SELECT FDepartment=CASE WHEN GROUPING(v3.FName)=1 THEN '销售部合计' ELSE (v3.FName) END,
        ...
        P_Money_1=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_1 THEN u1.FConsignAmount END),0),
        P_Money_2=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_2 THEN u1.FConsignAmount END),0),
        P_Money_3=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_3 THEN u1.FConsignAmount END),0),
        P_Money_4=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_4 THEN u1.FConsignAmount END),0),
        P_Money_5=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_5 THEN u1.FConsignAmount END),0),
        P_Money_6=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_6 THEN u1.FConsignAmount END),0),
        P_Money_7=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_7 THEN u1.FConsignAmount END),0),
        P_Money_8=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_8 THEN u1.FConsignAmount END),0),
        P_Money_9=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_9 THEN u1.FConsignAmount END),0),
        P_Money_10=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_10 THEN u1.FConsignAmount END),0),
        P_Money_11=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_11 THEN u1.FConsignAmount END),0),
        P_Money_12=ISNULL(SUM(CASE when CONVERT(char(6),v1.FDate,112) <= @Period_12 THEN u1.FConsignAmount END),0)
