...
into #tongbihuanbi
FROM(
    SELECT FSource=CASE WHEN GROUPING(v2.FComboBox)=1 THEN '<合计>' ELSE (v2.FComboBox) END, 
		FDepartment=CASE WHEN GROUPING(v3.FName)=1 THEN '<来源合计>' ELSE (v3.FName) END, 
...
order by t1.FSource,t1.C_Money desc
